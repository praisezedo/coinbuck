...
<div className="metrics-section relative overflow-hidden bg-[#2B1207] px-4 py-28">
        <div className="wireframe-globe absolute left-1/2 top-1/2 h-175 w-175 -translate-x-1/2 -translate-y-1/2 opacity-10">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
         <div className="metrics-heading text-center">
            ...
            <h2 className="mt-5 text-4xl font-black text-[#F4D03F] md:text-6xl">
              Built on trust.
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-lg text-[#F7E8C8]">
              Thousands of Nigerians trust CoinBuck to convert crypto quickly,
              securely and transparently.
            </p>
          </div>

<div className="metrics-grid mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {metrics.map((metric) => (
                <div
                key={metric.label}
      ...
      <div className="overflow-hidden bg-white py-24">
        <div className="mx-auto mb-12 max-w-7xl px-4 text-center">
          ...
          <h2 className="mt-5 text-4xl font-black text-[#2B1207] md:text-6xl">
        ...
        <div className="relative overflow-hidden">
          <div className="review-track flex w-max gap-6">
            {[...reviews, ...reviews].map((review, index) => (
              <div
                key={index}
                className="w-87.5 shrink-0 rounded-4xl border border-[#E8D7B8] bg-white p-6 shadow-[0_20px_50px_rgba(43,18,7,0.08)]"
              >
